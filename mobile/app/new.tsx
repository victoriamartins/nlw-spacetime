      ...
      <View className="mt-6 space-y-6">
        <View className="flex-row items-center gap-2">
          <Switch
            ...
            trackColor={{ false: '#767676', true: '#8257e5' }}
          />
        ...
        >
          {preview ? (
            ...
            <View className="flex-row items-center justify-center gap-2">
              <Icon name="image" color="#bebebf"></Icon>
        ...
        <TextInput
          ...
          className="p-0 font-body text-base leading-relaxed text-gray-100"
          placeholderTextColor="#56565a"
          textAlignVertical="top"
          placeholder="sinta-se livre para adicionar fotos, vídeos e 
          relatos sobre essa experiência que você quer lembrar para sempre"
        />
